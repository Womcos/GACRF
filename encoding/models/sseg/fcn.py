...
def get_fcn_resnet50_pcontext(pretrained=False, root=root_model, **kwargs):
...
def get_fcn_resnet50_ade(pretrained=False, root=root_model, **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
...
def get_fcn_resnest50_ade(pretrained=False, root=root_model, **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
...
def get_fcn_resnest50_pcontext(pretrained=False, root=root_model, **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
