...
def resnet50(pretrained=False, root=root_model, **kwargs):
...
def resnet101(pretrained=False, root=root_model, **kwargs):
...
def resnet152(pretrained=False, root=root_model, **kwargs):
