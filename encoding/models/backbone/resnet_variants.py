...
def resnet50s(pretrained=False, root=root_model, **kwargs):
...
def resnet101s(pretrained=False, root=root_model, **kwargs):
...
def resnet152s(pretrained=False, root=root_model, **kwargs):
...
# ResNet-D
def resnet50d(pretrained=False, root=root_model, **kwargs):
